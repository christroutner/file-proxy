...
// Local libraries.
import FileRESTControllerLib from './controller.js'
...
class FileRouter {
  constructor (localConfig = {}) {
    ...
    this.fileRESTController = new FileRESTControllerLib(dependencies)
  ...
  attach (app) {
    ...
    this.router.get('/:seedUrl/:urn/:filename', this.fileRESTController.getFile)
